namespace Dns.Projections.Api.Tests.Infrastructure
{
    using System;
    ...
    public static class ScenarioExtensions
    {
        ...
        private static async Task<object[]> AllRecords(this ApiProjectionsContext context)
        {
            ...
            records.AddRange(await context.DomainDetails.ToArrayAsync());
            records.AddRange(await context.DomainList.ToArrayAsync());
