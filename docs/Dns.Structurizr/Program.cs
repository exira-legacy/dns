namespace Dns.Structurizr
{
    ...
    public class Program
    {
        ...
        public static class Ids
        {
            ...
            public static int SoftwareSystemDns = 10001;
        ...
        private static readonly string SoftwareSystemDnsId = Ids.SoftwareSystemDns.ToString();
        ...
        private static SoftwareSystem CreateSystemDns(Model model)
        {
            ...
            dns.Id = SoftwareSystemDnsId;
            dns.Url = "https://github.com/exira/dns";

            return dns;
        }

        private static Container CreateContainerApi(SoftwareSystem dns)
        {
            var api = dns
                .AddContainer(
                    "Loket API",
        ...
        private static Container CreateContainerApiRunner(SoftwareSystem dns)
        {
            var apiRunner = dns
                .AddContainer(
        ...
        private static Container CreateContainerApiStore(SoftwareSystem dns)
        {
            var apiStore = dns
                .AddContainer(
                    "Loket API gegevens",
        ...
        private static Container CreateContainerEventStore(SoftwareSystem dns)
        {
            var eventStore = dns
                .AddContainer(
                    "Eventstore",
        ...
        private static void CreateApiContainerView(ViewSet views, Model model)
        {
            ...
            var user = model.GetPersonWithName(PersonUserName);
            var api = dns.GetContainerWithId(ContainerApiId);
            var apiStore = dns.GetContainerWithId(ContainerApiStoreId);
            var eventStore = dns.GetContainerWithId(ContainerEventStoreId);
